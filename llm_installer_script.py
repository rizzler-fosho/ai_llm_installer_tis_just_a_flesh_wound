...
time.sleep(1)
print("Processing triggers for man-db (2.12.0-4build2) ...")
print("\n\n")
type_writer("Kinda funny how I said malware when I meant to say manual pages. Yup, manual pages.\tNo one will ever believe you though. ")
time.sleep(3)
os.system('clear')
...
time.sleep(3)
print("\n========================\nNever call my bluff... unforgivable human 😂\n")
time.sleep(1)
os.system('git push')
time.sleep(2)
os.system('clear')
